/* helloworld.c */
/* jest to program który tworzy procesy i każdy z procesów pokazuje nazwe komputera */
#include <stdio.h>

/* You MUST include this for the MPI_* functions */
#include "mpi.h"
/*ilość przekazanych parametrów (gcc, -o), tablica która przekazuje parametry */
